window.SEARCH_DATA = {
  ...
  taxonomies: {
    sector: [
      {
        label: "Education",
        children: ["Higher education", "Learning design", "Tutoring"]
      },
      {
        label: "Environmental science",
        children: ["Conservation", "Ecology", "Policy"]
      },
      {
        label: "Healthcare",
        children: ["Clinical research", "Laboratory science", "Community health"]
      },
      {
        label: "Technology",
        children: ["Data & analytics", "Software engineering", "Machine learning"]
      }
    ],
    jobTitle: [
      {
        label: "Scientist",
        children: ["Environmental scientist", "Laboratory scientist", "Research scientist"]
      },
      {
        label: "Research",
        children: ["Research assistant", "Research fellow", "Health researcher"]
      },
      {
        label: "Data",
        children: ["Data analyst", "Data coordinator", "Policy analyst"]
      },
      {
        label: "Engineering",
        children: ["Software engineer", "Front-end developer", "Bioinformatics engineer"]
      },
      {
        label: "Teaching",
        children: ["Lecturer", "Learning designer", "Tutor"]
      }
    ]
  },
  jobs: [
    {
      ...
      sector: "Conservation", locationGroup: "New York", jobseekerType: "Experienced",
      contractType: "Permanent", jobTitle: "Environmental scientist", hours: "Full time", organisationType: "Charity",
    ...
    },
    {
      ...
      sector: "Clinical research", locationGroup: "New York", jobseekerType: "Early career",
      contractType: "Fixed term", jobTitle: "Research assistant", hours: "Full time", organisationType: "University",
    ...
    },
    {
      ...
      sector: "Laboratory science", locationGroup: "New York", jobseekerType: "Experienced",
      contractType: "Permanent", jobTitle: "Laboratory scientist", hours: "Full time", organisationType: "Hospital",
    ...
    },
    {
      ...
      sector: "Clinical research", locationGroup: "Boston", jobseekerType: "Early career",
      contractType: "Fixed term", jobTitle: "Research assistant", hours: "Full time", organisationType: "Hospital",
      remote: false, postedDays: 2, badge: "New"
    },
    {
      ...
      sector: "Data & analytics", locationGroup: "Remote", jobseekerType: "Experienced",
      contractType: "Permanent", jobTitle: "Data analyst", hours: "Part time", organisationType: "Private sector",
    ...
    },
    {
      ...
      sector: "Software engineering", locationGroup: "San Francisco", jobseekerType: "Experienced",
      contractType: "Permanent", jobTitle: "Software engineer", hours: "Full time", organisationType: "Private sector",
    ...
    },
    {
      ...
      sector: "Ecology", locationGroup: "Detroit", jobseekerType: "Early career",
      contractType: "Fixed term", jobTitle: "Environmental scientist", hours: "Full time", organisationType: "Charity",
    ...
    },
    {
      ...
      sector: "Clinical research", locationGroup: "Chicago", jobseekerType: "Experienced",
      contractType: "Permanent", jobTitle: "Data coordinator", hours: "Full time", organisationType: "Hospital",
    ...
    },
    {
      ...
      sector: "Higher education", locationGroup: "Philadelphia", jobseekerType: "Experienced",
      contractType: "Permanent", jobTitle: "Lecturer", hours: "Full time", organisationType: "University",
    ...
    },
    {
      ...
      sector: "Software engineering", locationGroup: "Boston", jobseekerType: "Early career",
      contractType: "Permanent", jobTitle: "Front-end developer", hours: "Full time", organisationType: "Private sector",
    ...
    },
    {
      ...
      sector: "Ecology", locationGroup: "Seattle", jobseekerType: "Experienced",
      contractType: "Fixed term", jobTitle: "Research fellow", hours: "Full time", organisationType: "University",
    ...
    },
    {
      ...
      sector: "Software engineering", locationGroup: "Austin", jobseekerType: "Experienced",
      contractType: "Permanent", jobTitle: "Bioinformatics engineer", hours: "Full time", organisationType: "Private sector",
    ...
    },
    {
      ...
      sector: "Community health", locationGroup: "Boston", jobseekerType: "Early career",
      contractType: "Fixed term", jobTitle: "Health researcher", hours: "Part time", organisationType: "Charity",
      remote: false, postedDays: 3, badge: ""
    },
    {
      ...
      sector: "Policy", locationGroup: "New York", jobseekerType: "Experienced",
      contractType: "Permanent", jobTitle: "Policy analyst", hours: "Full time", organisationType: "Charity",
    ...
    },
    {
      ...
      sector: "Learning design", locationGroup: "Remote", jobseekerType: "Experienced",
      contractType: "Permanent", jobTitle: "Learning designer", hours: "Part time", organisationType: "Private sector",
    ...
    },
    {
      ...
      sector: "Laboratory science", locationGroup: "Detroit", jobseekerType: "Early career",
      contractType: "Permanent", jobTitle: "Laboratory scientist", hours: "Full time", organisationType: "Hospital",
      remote: false, postedDays: 1, badge: "New"
    },
    {
      ...
      sector: "Tutoring", locationGroup: "New York", jobseekerType: "Early career",
      contractType: "Fixed term", jobTitle: "Tutor", hours: "Part time", organisationType: "University",
      remote: false, postedDays: 5, badge: ""
    },
    {
      ...
      sector: "Machine learning", locationGroup: "San Francisco", jobseekerType: "Experienced",
      contractType: "Fixed term", jobTitle: "Research scientist", hours: "Full time", organisationType: "Private sector",
